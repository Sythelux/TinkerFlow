...
// [InitializeOnLoad]
    ...
    {
        internal const string LastEditedProcessNameKey = "TinkerFlow.Core/Editor.Godots/LastEditedProcessName";
        ...
        internal static void SetStrategy(IEditingStrategy newStrategy)
        {
            ...
            if (newStrategy == null)
            {
                GD.PushError("An editing strategy cannot be null, set to default instead.");
                SetDefaultStrategy();
            }
        }
        ...
        private static void OnSceneOpened(Node scene)
        {
