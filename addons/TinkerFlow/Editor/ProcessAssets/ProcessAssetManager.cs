...
namespace VRBuilder.Editor
{
    ...
    internal static class ProcessAssetManager
    {
        ...
        internal static void Import(IProcess process)
        {
            ...
            {
                GD.PushWarning($"We detected a name collision while importing process \"{oldName}\". We have renamed it to \"{process.Data.Name}\" before importing.");
            }
        ...
        internal static void Import(string path, IProcessSerializer serializer)
        {
            ...
            {
                GD.PushError($"The file extension of {path} does not match the expected file extension of {serializer.FileFormat} of the current serializer.");
            }
