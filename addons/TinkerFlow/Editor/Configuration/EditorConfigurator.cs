...
namespace VRBuilder.Editor.Configuration
{
    ...
    public static class EditorConfigurator
    {
        ...
        private static void ApplyConfigurationExtensions()
        {
            ...
            if (conflicts > 0)
            {
                GD.PushWarning($"Conflicts in editor configuration extensions: {conflicts} items were both required and disabled by different extensions. They have been enabled.");
            }
