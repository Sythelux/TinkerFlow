...
#pragma warning restore 0618
        ...
        /// <inheritdoc />
        public IProcessSerializer Serializer { get; set; } = new GodotJsonProcessSerializerV1();
        ...
        public virtual ISceneConfiguration SceneConfiguration
        {
            get
            {
                if (sceneConfiguration == null)
                {
                    ...
                    {
                        configuration = RuntimeConfigurator.Instance.AddComponent<SceneConfiguration>();
                    }
