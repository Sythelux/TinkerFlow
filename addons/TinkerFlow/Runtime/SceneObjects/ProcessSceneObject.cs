...
namespace VRBuilder.Core.SceneObjects
{
    ...
    public partial class ProcessSceneObject : Node3D, ISceneObject, ITagContainer
    {
        ...
        public IEnumerable<ISceneObjectProperty> Properties
        {
            get { return GetChildren().OfType<ISceneObjectProperty>(); }
        }
        ...
        protected void Awake()
        {
            ...
            var processSceneObjects = FindChildren("*", recursive: true).OfType<ProcessSceneObject>();
