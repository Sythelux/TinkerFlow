...
public class CompositeProcess : IStageProcess
{
    ...
    public void Start()
    {
        foreach (IStageProcess childProcess in stageProcesses) childProcess.Start();
    }
    ...
    public IEnumerator Update()
    {
        ...
        var isAnyRequiredUpdateRuns = true;
    ...
    public void End()
    {
        foreach (IStageProcess childProcess in stageProcesses) childProcess.End();
    }

    /// <inheritdoc />
    public void FastForward()
    {
        foreach (IStageProcess childProcess in stageProcesses) childProcess.FastForward();
    }
}