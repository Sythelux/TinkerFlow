...
public class TransitionCollection : Entity<TransitionCollection.EntityData>, ITransitionCollection
{
    ...
    public class EntityData : EntityCollectionData<ITransition>, ITransitionCollectionData
    {
        ///<inheritdoc />
        [DataMember]
        //TODO: [DisplayName(""), KeepPopulated(typeof(Transition)), ReorderableListOf(typeof(FoldableAttribute), typeof(DeletableAttribute)), ExtendableList]
    ...
    private class ActiveProcess : StageProcess<EntityData>
    {
        ...
        {
            while (Data.Transitions.All(transition => transition.IsCompleted == false)) yield return null;
        }
    ...
    ///<inheritdoc />
    ITransitionCollectionData IDataOwner<ITransitionCollectionData>.Data => Data;
    ...
    {
        var clonedTransitionCollection = new TransitionCollection();
