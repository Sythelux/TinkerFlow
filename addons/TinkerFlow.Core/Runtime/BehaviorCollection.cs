...
public class BehaviorCollection : Entity<BehaviorCollection.EntityData>, IBehaviorCollection
{
    ...
    public class EntityData : EntityCollectionData<IBehavior>, IBehaviorCollectionData
    {
        ...
        /// </summary>
        [DataMember]
        // TODO: [DisplayName(""), ReorderableListOf(typeof(FoldableAttribute), typeof(DeletableAttribute), typeof(DrawIsBlockingToggleAttribute), typeof(HelpAttribute)), ExtendableList]
    ...
    {
        var clonedBehaviorCollection = new BehaviorCollection();
    ...
    /// <inheritdoc />
    IBehaviorCollectionData IDataOwner<IBehaviorCollectionData>.Data => Data;
