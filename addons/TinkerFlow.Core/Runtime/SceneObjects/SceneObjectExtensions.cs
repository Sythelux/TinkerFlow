...
public static class SceneObjectExtensions
{
    ...
    public static ISceneObjectProperty AddProcessProperty(this ISceneObject sceneObject, Type processProperty)
    {
        ...
        var sceneObjectProperty = sceneObject.GameObject.FindChildren("*", recursive: true).FirstOrDefault(c => c.GetType() == processProperty) as ISceneObjectProperty;

        if (sceneObjectProperty != null) return sceneObjectProperty;
        ...
        if (processProperty.IsInterface || processProperty.IsAbstract)
        {
            ...
            //TODO: sceneObjectProperty = sceneObject.GameObject.AddComponent(propertyType) as ISceneObjectProperty;
        }
        else
        {
            //TODO: sceneObjectProperty = sceneObject.GameObject.AddComponent(processProperty) as ISceneObjectProperty;
        }
    ...
    public static void AddProcessPropertyExtensions(this ISceneObjectProperty property)
    {
        ...
        foreach (Type concreteExtension in availableExtensions)
        {
            ...
            {
                //TODO: property.SceneObject.GameObject.AddComponent(concreteExtension);
            }
        }
    }
    ...
    public static void RemoveProcessProperty(this ISceneObject sceneObject, Type processProperty, bool removeDependencies = false, IEnumerable<Component>? excludedFromBeingRemoved = null)
    {
        ...
        if (AreParametersNullOrInvalid(sceneObject, processProperty) || processComponent == null) return;
    ...
    {
//             TODO: IEnumerable<Component> processProperties = sceneObject.GameObject.GetComponents(typeof(Component)).Where(component => component.GetType() != typeToRemove);
//
...
//             }
    ...
    {
        //TODO: Type propertyType = component.GetType();
    ...
    {
        // TODO: RequireComponent[] requireComponents = processProperty.GetCustomAttributes(typeof(RequireComponent), false) as RequireComponent[];
        //
        // if (requireComponents == null || requireComponents.Length == 0)
        // {
        //     return null;
